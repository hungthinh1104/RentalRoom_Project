...
import { Coins, History, Zap, Receipt, Plus, FileText, LayoutDashboard } from 'lucide-react';
                ...
                <TabsContent value="expenses" className="space-y-6 focus-visible:outline-none">
                    <div className="bg-card p-4 rounded-xl border shadow-sm flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            ...
                            <div>
                                <h3 className="font-semibold">Quản lý chi phí</h3>
                                <p className="text-sm text-muted-foreground">Theo dõi các khoản chi vận hành</p>
                            </div>
                        </div>
                        <Select
                            value={historyYear.toString()}
