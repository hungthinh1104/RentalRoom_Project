			...
			<Card className="border border-border/70 bg-gradient-to-br from-card/90 via-card/70 to-muted/60 backdrop-blur-xl rounded-[32px] shadow-xl shadow-muted/30">
				...
				<CardContent className="pt-4 space-y-4">
					...
					{!paymentsQuery.isLoading && payments.map((payment: Payment) => {
						...
						return (
							<div key={payment.id} className="rounded-3xl border border-border/70 bg-gradient-to-br from-card/90 via-card/70 to-muted/60 backdrop-blur-xl p-4 md:p-5 shadow-lg shadow-muted/30 flex flex-col gap-3 transition-all duration-200 hover:border-primary/30 hover:shadow-primary/10">
