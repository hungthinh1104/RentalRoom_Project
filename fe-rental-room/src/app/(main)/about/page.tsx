...
const stats = [
  { label: 'Phòng trọ', value: '10,000+', icon: Building2 },
  { label: 'Người dùng', value: '50,000+', icon: Users },
  { label: 'Chủ nhà', value: '5,000+', icon: Award },
...
const values = [
  {
    title: 'Sứ mệnh',
    icon: Target,
    description: 'Kết nối người tìm phòng với chủ nhà một cách nhanh chóng, minh bạch và an toàn nhất.',
    color: 'from-blue-500 to-cyan-500',
  },
  {
    title: 'Tầm nhìn',
    icon: TrendingUp,
    description: 'Trở thành nền tảng cho thuê phòng trọ hàng đầu Việt Nam, nơi mọi người tìm thấy ngôi nhà lý tưởng.',
