...
function SelectItem({
  ...
  const isEmptyValue = typeof props.value === "string" && props.value.trim() === ""
  const safeValue = isEmptyValue ? "__empty__" : props.value
  return (
    <SelectPrimitive.Item
      data-slot="select-item"
      data-empty-value={isEmptyValue ? "true" : undefined}
      className={cn(
      ...
      {...props}
      value={safeValue}
      disabled={props.disabled || isEmptyValue}
    >
