...
import { favoritesApi, FavoriteRoom } from "@/lib/api/favorites-api";
...
export default function RoomDetailPage({ params }: RoomDetailPageProps) {
  ...
  const favorites = (favoritesData || []) as FavoriteRoom[];
  const isBookmarked = favorites.some((fav) => fav.roomId === id);
