...
export default function LandlordSettingsPage() {
    ...
    const handlePasswordChange = async () => {
        ...
        try {
            ...
            const errorMessage = error instanceof ApiError ? error.message : 'Không thể thay đổi mật khẩu';
            toast({
                title: 'Lỗi',
    ...
    const handleResendVerification = async () => {
        try {
            ...
            const message = error instanceof ApiError ? error.message : 'Không thể gửi email xác thực';
            toast({
                title: 'Lỗi',
                description: message,
                variant: 'destructive',
        ...
        <div className="p-4 sm:p-6 max-w-5xl mx-auto space-y-4 sm:space-y-6">
            ...
            <Tabs defaultValue="password" className="space-y-6">
                ...
                <TabsContent value="security" className="space-y-6">
                    <div className="bg-card border-2 border-border rounded-xl p-4 sm:p-6 lg:p-8">
                        <div className="flex items-center justify-between mb-4 sm:mb-6">
                            <h2 className="text-xl sm:text-2xl font-bold text-foreground">Xác Thực Hai Yếu Tố (2FA)</h2>
                ...
                <TabsContent value="notifications" className="space-y-6">
                    <div className="bg-card border-2 border-border rounded-xl p-4 sm:p-6 lg:p-8">
                        <div className="flex items-center justify-between mb-4 sm:mb-6">
                            <h2 className="text-xl sm:text-2xl font-bold text-foreground">Thông Báo Email</h2>
                            <span className="px-3 py-1 bg-warning/10 text-warning text-xs font-bold rounded-full border border-warning/20">
                                Sắp ra mắt
                            </span>
                        </div>
