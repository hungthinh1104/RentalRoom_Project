...
export default function LandlordFeedbackPage() {
    ...
    return (
        <div className="container py-8 max-w-5xl space-y-8">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight">Hỗ trợ & Phản hồi Hệ thống</h1>
                    <p className="text-muted-foreground mt-2">
                        Gửi yêu cầu hỗ trợ kỹ thuật hoặc báo lỗi hệ thống
                    </p>
                </div>
                ...
                {isLoading ? (
                    ...
                    <Card className="border-dashed">
                        <CardContent className="flex flex-col items-center justify-center p-12 text-center space-y-4">
                            ...
                            <div>
                                <h3 className="text-lg font-semibold">Chưa có yêu cầu nào</h3>
                                <p className="text-sm text-muted-foreground max-w-xs mx-auto mt-1">
                                    Danh sách các yêu cầu hỗ trợ và báo lỗi của bạn sẽ xuất hiện tại đây.
                                </p>
                            </div>
