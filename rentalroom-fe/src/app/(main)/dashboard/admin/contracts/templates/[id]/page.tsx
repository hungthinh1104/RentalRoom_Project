...
import { ArrowLeft, Save, FileCode, GitCompare, X, Eye } from "lucide-react";
...
import { ContractType } from "@/features/contracts/types/template.types";
...
export default function ContractTemplateEditorPage() {
    ...
    const [compareData, setCompareData] = useState<{ old: string | null; new: string | null; info: any } | null>(null);
                                        ...
                                        {history.length === 0 ? (
                                            ...
                                            history.map((log) => (
                                                <div
                                                    ...
                                                    onClick={() => log.action === "EDIT" && setCompareData({ old: log.oldContent, new: log.newContent, info: log })}
                                                >
