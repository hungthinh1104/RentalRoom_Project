...
export const metadata: Metadata = {
    title: 'Hestia - Nền tảng Quản lý Cho thuê Thông minh',
    ...
    openGraph: {
        title: 'Hestia - AI-Powered Property Management Platform',
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: 'Hestia Property Management Platform',
            },
        ],
        locale: 'vi_VN',
        type: 'website',
    ...
    twitter: {
        ...
        title: 'Hestia - Quản lý Cho thuê Thông minh',
