...
export class ReportsController {
  ...
  /**
   * GET /reports/landlord/expenses
   * Get expense report for landlords
   */
  @Get('landlord/expenses')
  @Roles(UserRole.LANDLORD, UserRole.ADMIN)
  @ApiOperation({
    summary: 'Get landlord expense report',
    description: 'Returns aggregated expenses and maintenance costs',
  })
  async getLandlordExpenses(@Query() query: LandlordRevenueQueryDto) {
    return this.landlordService.getLandlordExpenses(query.landlordId, query);
  }
