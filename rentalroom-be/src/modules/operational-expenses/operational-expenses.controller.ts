...
export class OperationalExpensesController {
    ...
    findAll(@CurrentUser() user: User, @Query() filter: FilterOperationalExpenseDto) {
    ...
    update(@CurrentUser() user: User, @Param('id') id: string, @Body() dto: UpdateOperationalExpenseDto) {
